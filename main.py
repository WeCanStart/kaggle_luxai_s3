...
if __name__ == "__main__":
    ...
    file = "huyatina"
    if os.path.isfile(file) and not os.path.isdir("f"):
        os.mkdir("f")
    ...
    while True:
        ...
        # if profiler and i % 50 == 0:
        #     profiler.stop()
        #     with open(f"C:\\Users\\artem\\Desktop\\f\\profiler{raw_input["player"]}_{i}.txt", "w", encoding="utf-8") as f:
